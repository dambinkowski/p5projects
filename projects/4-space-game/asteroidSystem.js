class AsteroidSystem {
  ...
  spawn(){
    ...
    if(this.dificulty != 500) // max dificulty is 500 meaning there is astroid spawing at every frame 
        this.dificulty+=0.01; // games gets slightly harder with every call of spawn function wich is every frame
  }
